...
const projects = [
  {
    ...
    description: "Cinco is a comprehensive web application built for sports venue and activity management, enabling seamless scheduling, booking, and game hosting in one platform",
  ...
  },
  {
    ...
    description: "Clydios is an AI-powered CRM that automates inbound and outbound calls, from lead capture to conversion, with real-time tracking of sales pipeline.", image: "/image/portfolio/clydios.png",
