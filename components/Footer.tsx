        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-gray-700 hover:bg-primary rounded-full p-3 transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/it-solutions" className="text-gray-300 hover:text-primary transition-colors">
                  IT Solutions
                </Link>
              </li>
              <li>
                <Link href="/crm-automation" className="text-gray-300 hover:text-primary transition-colors">
                  CRM & Automation
                </Link>
              </li>
              <li>
                <Link href="/branding" className="text-gray-300 hover:text-primary transition-colors">
                  Branding & Design
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/ai-tools" className="text-gray-300 hover:text-primary transition-colors">
                  AI Solutions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <a href="tel:3023907520" className="text-gray-300 hover:text-primary transition-colors">
                  (302) 390-7520
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:abrersharief@techmeup.us" className="text-gray-300 hover:text-primary transition-colors break-all">
              ...
              <li className="flex items-center">
                ...
                <a href="https://techmeup.us" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors">
                  TechMeUp.us
                </a>
              </li>
            </ul>
